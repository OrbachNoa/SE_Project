...
# NOTE: TC-AC-024 (test_get_cluster_schedule_scores_recomputes_extended_metrics)
# moved to tests/gui/unit/Test_ClusterSessionController.py — clustering session
