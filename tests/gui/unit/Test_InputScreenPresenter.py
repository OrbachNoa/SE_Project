...
class FakeView:
    def __init__(self, is_valid=False):
        self.is_period_range_valid_value = is_valid
...
def test_presenter_refresh_generate_button_invalid_dates(mock_controller, mock_router):
    ...
    # Assert
    assert view.generate_button_calls == [(False, "Fix the exam period dates (end is before start) to continue.")]
