...
class ScheduleCsvFormatter:
    """
    Responsible for converting a ScheduleViewModel object into a simple 
    tabular structure (headers and rows) suitable for CSV export.
    Matches the exact layout and data of the PDF export.
    """
    
    @staticmethod
    def format(schedule_view) -> tuple[list[str], list[list[str]]]:
